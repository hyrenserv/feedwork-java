...
public class SystemUtil {
	 ...
	 * @since Java 1.2
	 */
	public static final String JAVA_IO_TMPDIR = getSystemProperty(JAVA_IO_TMPDIR_PROP);
	...
	public static File getJavaHome() {
		return new File(System.getProperty(JAVA_HOME_PROP));
	}
	...
	public static File getJavaIoTmpDir() {
		return new File(System.getProperty(JAVA_IO_TMPDIR_PROP));
	}
	...
	public static File getUserDir() {
		return new File(System.getProperty(USER_DIR_PROP));
	}
	...
	public static File getUserHome() {
		return new File(System.getProperty(USER_HOME_PROP));
	}
	...
	public SystemUtil() {
		throw new AssertionError("No SystemUtil instances for you!");
	}
