...
public class FileDeleteStrategy {
	private static final Logger logger = LogManager.getLogger(FileDeleteStrategy.class.getName());
	/**
...
//	public static final FileDeleteStrategy FORCE = new ForceFileDeleteStrategy();
	...
	public boolean deleteQuietly(final File fileToDelete) {
		...
		try {
			...
			logger.warn("delete '"+fileToDelete+"' failed", ex);
			return false;
		}
	}
	...
	static class ForceFileDeleteStrategy extends FileDeleteStrategy {
		...
		@Override
		protected boolean doDelete(final File fileToDelete) throws IOException {
			FileUtil.forceDelete(fileToDelete);
			return true;
		}
	}
}
