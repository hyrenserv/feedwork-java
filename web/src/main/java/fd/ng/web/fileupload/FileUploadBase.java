...
import fd.ng.web.fileupload.MultipartStream.ItemInputStream;
import fd.ng.web.fileupload.servlet.ServletFileUpload;
import fd.ng.web.fileupload.util.Closeable;
import fd.ng.web.fileupload.util.FileItemHeadersImpl;
import fd.ng.web.fileupload.util.LimitedInputStream;
import fd.ng.web.fileupload.util.Streams;
 ...
 * Use {@link #parseRequest(RequestContext)} to acquire a list of {@link FileItem}s associated with a given HTML
 * widget.</p>
 *
...
public abstract class FileUploadBase {
    private static final Logger logger = LogManager.getLogger(FileUploadBase.class.getName());
        ...
        try {
            ...
            while (iter.hasNext()) {
                ...
                try {
                    ...
                    throw new FileUploadException(format("Processing of %s request failed. %s",
            ...
            if (!successful) {
                for (FileItem fileItem : items) {
                    try {
                        ...
                        logger.warn("clean '"+fileItem.getFieldName()+"' failed!", e);
                    }
                }
            }
        }
    ...
    /**
     * 把上传的form元素重构到Map中，保证同名元素被存入一个List中，该Map等价于 request.getParameterMap
     *
     * @param ctx The context for the request to be parsed.
     *
    ...
    public Map<String, List<FileItem>> parseParameterMap(RequestContext ctx) {
        ...
        for (FileItem fileItem : items) {
            String fieldName = fileItem.getFieldName(); // form元素的name
...
//    }
    ...
    private class FileItemIteratorImpl implements FileItemIterator {
        ...
        FileItemIteratorImpl(RequestContext ctx) throws FileUploadException, IOException {
            ...
            InputStream input; // this is eventually closed in MultipartStream processing
            if (sizeMax >= 0) {
    ...
    public static class InvalidContentTypeException extends FileUploadException {
        private static final long serialVersionUID = -7821987716162833817L;
    ...
    protected abstract static class SizeException extends FileUploadException {
        private static final long serialVersionUID = 3578204189643011129L;
        /**
    ...
    public static class SizeLimitExceededException extends SizeException {
        private static final long serialVersionUID = 6732111782532122780L;
    ...
    public static class FileSizeLimitExceededException extends SizeException {
        private static final long serialVersionUID = 5371494604223055787L;
        /**
