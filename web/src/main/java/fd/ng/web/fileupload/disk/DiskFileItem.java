...
import fd.ng.core.utils.IOUtil;
import fd.ng.core.utils.file.DeferredFileOutputStream;
import fd.ng.web.fileupload.FileItem;
import fd.ng.web.fileupload.FileUploadException;
import fd.ng.web.fileupload.ParameterParser;
 ...
 * {@link fd.ng.web.fileupload.servlet.ServletFileUpload
    ...
    public void write(File file) throws Exception {
        if (isInMemory()) {
            ...
            if (outputFile != null) {
                 ...
                 * desired file.
                 */
                FileUtil.moveFile(outputFile, file);
            } else {
                /*
